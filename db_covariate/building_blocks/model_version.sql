...
CREATE TABLE model_version (
  ...
  code_version varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'The source code repository information. Provides the ability to recreate the code used to make this model_version',
...
-- Add our foreign key and unique constraints
...
-- Create our indices
CREATE INDEX fk_model_version_covariate_id ON model_version (covariate_id);
CREATE INDEX fk_model_version_gbd_round_id ON model_version (gbd_round_id);
CREATE INDEX fk_model_version_covariate_gbd_round_ids ON model_version (covariate_id, gbd_round_id);
